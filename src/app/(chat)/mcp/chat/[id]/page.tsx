...
import { Chat } from "@/components/mcp/chat";
import { getChatById, getMessagesByChatId } from "@/lib/mcp-chat/db/queries";
import { DataStreamHandler } from "@/components/mcp/data-stream-handler";
import { DEFAULT_CHAT_MODEL } from "@/lib/mcp-chat/ai/models";
import { DBMessage } from "@/lib/mcp-chat/db/schema";
import { Attachment, UIMessage } from "ai";
import { BASE_METADATA, BASE_TITLE } from "@/lib/mcp-chat/constants";
import {
  getEffectiveSession,
  shouldPersistData,
} from "@/lib/mcp-chat/auth-utils";
import { hasValidAPIKeys } from "@/lib/mcp-chat/ai/api-keys";
...
export async function generateMetadata({
  ...
  const description =
    firstUserMessage && Array.isArray(firstUserMessage.parts)
      ? (firstUserMessage.parts as any[]).find((part) => part.type === "text")
          ?.text || BASE_TITLE
      : BASE_TITLE;
