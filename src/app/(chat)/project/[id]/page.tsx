      ...
      <div className="max-w-3xl mx-auto fade-in animate-in w-full mt-14">
        ...
        <div className="flex my-4 mx-2 gap-4">
          <FeatureCard
            title="Add Files"
            onClick={() => {
              // Show toast with more visibility
              toast.success(
                "📎 Upload files using the paperclip button in the chat input below. Each file costs 10 credits.",
                {
                  duration: 5000,
                  position: "top-center",
                },
              ...
              // Scroll to the input to highlight where to upload
              setTimeout(() => {
                ...
                if (inputElement) {
                  ...
                  const parentForm =
                    ...
                    inputElement.closest(".border");
                  if (parentForm) {
                    parentForm.classList.add(
                      "ring-2",
                      "ring-blue-500",
                      "ring-opacity-50",
                    );
                    setTimeout(() => {
                      parentForm.classList.remove(
                        "ring-2",
                        "ring-blue-500",
                        "ring-opacity-50",
                      );
