...
// Schema de validation pour les fichiers uploadés
const FileSchema = z.object({
  file: z
    ...
    .refine(
      (file) =>
        [
          // Images supportées par OpenAI Vision
          "image/jpeg",
          "image/png",
          "image/webp",
          "image/gif",
      ...
      {
        message:
          "File type not supported. Supported: images (JPEG, PNG, WebP, GIF), PDF, Word, Excel, PowerPoint, and text files",
      },
    ),
});
