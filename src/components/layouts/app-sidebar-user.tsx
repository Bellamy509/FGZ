...
export function AppSidebarUser({
  ...
  // Fetch user credits dynamically
  const { data: creditsData } = useSWR<UserCreditsResponse>(
        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuLabel className="p-0 font-normal">
              <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs text-muted-foreground">
                    Available Credits: {creditsData?.credits ?? "..."}
                  </span>
                </div>
              </div>
            </DropdownMenuLabel>
            ...
            <DropdownMenuItem
              onClick={() => {
                window.open(
                  "https://join.slack.com/t/lakayaicommunity/shared_invite/zt-3af9o7d9t-sUz9L8_P5dRkrSNPL1H8aw",
                  "_blank",
                );
              }}
            >
              <SlackIcon className="size-4 fill-foreground" />
              <span>{t("joinSlackCommunity")}</span>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
