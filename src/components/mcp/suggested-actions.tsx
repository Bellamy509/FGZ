  ...
  const suggestedActions: SuggestedAction[] = [
    {
      ...
      action:
        "Help me prep for my next meeting in my Google Calendar by telling me what it is and a bit about who the attendees are using a web search.",
      appSlugs: ["app_13Gh2V"],
      webSearchIcon: true,
    },
    {
      ...
      action:
        "Tell me about the most recent 5 customers in Stripe — who are they and how much were their invoices?",
      appSlugs: ["app_OD5hrX"],
    },
    {
      ...
      action:
        "Summarize the 10 most recently closed PRs in GitHub and draft a changelog announcement for me in a Notion doc.",
    ...
    },
    {
      ...
      label: "for next week",
      action:
        "Summarize the events on my calendar for next week and give me some of the key takeaway, not every single detail.",
      appSlugs: ["app_13Gh2V"],
    },
  ];
            ...
            >
              ...
              >
                <div className="flex justify-between items-start w-full">
                  ...
                  {((suggestedAction.appSlugs &&
                    suggestedAction.appSlugs.length > 0) ||
                    suggestedAction.webSearchIcon) && (
                    <div className="flex items-center gap-1.5 ml-2 flex-shrink-0">
                      {/* Add web search icon */}
                      {suggestedAction.webSearchIcon && (
                        <div className="size-5 rounded-sm overflow-hidden flex items-center justify-center bg-muted/20">
                      ...
                      {suggestedAction.appSlugs &&
                        suggestedAction.appSlugs
                          .slice(0, suggestedAction.webSearchIcon ? 2 : 3)
                          .map((slug) => (
                            <div
                              key={`app-icon-${slug}`}
